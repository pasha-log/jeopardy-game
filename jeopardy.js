    ...
    return arr.every(function(val){
     ...
     function randomCat() {
        ...
        while (sixCat.length < 6) {
            const categories = [209, 1892, 4483, 88, 218, 1072, 881, 7355, 574, 16, 
                3336, 6224, 14701, 388, 7347, 380, 411, 1147, 1686, 2760, 1808, 651, 
                726, 1404, 3333, 1150, 1140, 2350, 538, 863, 530, 50, 809, 7740, 286, 1559,
                 9238, 255, 12876, 6436, 3968, 1896, 14508, 11948, 10646, 16250, 311, 7312, 49, 770, 17982, 1445, 131];
...
function setupAndStart() {
    $('#jeopardy').after('<button id="restart">Restart</button>')
